...
import type { PathResult, Goal } from './types';
...
export {
  ...
  WORLD_FLOOR_Y,
  Dimension,
  type BlockPos as WorldBlockPos, // Alias to avoid conflict with types.BlockPos
  getTicks,
  toVec3,
  toBlockPos,
  getCurrentDimension,
  ...
  type CachedProjectile as ProjectileCacheData, // Alias to avoid conflict with trackers
} from './utils';

// ---- Control System (AltoClef additions) ----
export {
  InputControls,
  Input,
  createInputControls,
