/**
 * StrongholdTask - Stronghold Location and Navigation Tasks
 * Based on BaritonePlus's LocateStrongholdCoordinatesTask.java and GoToStrongholdPortalTask.java
 *
...
export { LocateState, GoToStrongholdState, EyeDirection, calculateIntersection };
