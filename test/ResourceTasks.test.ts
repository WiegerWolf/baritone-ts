...
import {
  ...
  itemTarget,
  Dimension,
} from '../src/tasks/concrete/ResourceTask';
import {
  MineAndCollectTask,
  mineAndCollect,
  mineOre,
} from '../src/tasks/concrete/MineAndCollectTask';
import {
  KillAndLootTask,
  killAndLoot,
  huntForFood,
  huntMobForDrop,
} from '../src/tasks/concrete/KillAndLootTask';
import {
  CollectFuelTask,
  collectFuel,
  collectFuelForSmelting,
  FUEL_SOURCES,
} from '../src/tasks/concrete/CollectFuelTask';
import { Task } from '../src/tasks/Task';
import type { ITask } from '../src/tasks/interfaces';
