...
import {
  ...
  returnToOverworld,
  goToDimension,
} from '../src/tasks/concrete/PortalTask';
import {
  ArmorSlot,
  ArmorMaterial,
  EquipArmorTask,
  ...
  equipBestArmor,
  equipArmor,
} from '../src/tasks/concrete/ArmorTask';
import {
  PlaceBedAndSetSpawnTask,
  SleepInBedTask,
  placeBedAndSetSpawn,
  sleepInBed,
} from '../src/tasks/concrete/BedTask';
import {
  LiquidType,
  ...
  collectWater,
  collectLava,
} from '../src/tasks/concrete/CollectLiquidTask';
import {
  DodgeProjectilesTask,
  StrafeAndDodgeTask,
  dodgeProjectiles,
  strafeAndDodge,
} from '../src/tasks/concrete/DodgeTask';
import { Dimension } from '../src/tasks/concrete/ResourceTask';
